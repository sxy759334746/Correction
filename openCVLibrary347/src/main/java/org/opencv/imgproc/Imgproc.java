...
public class Imgproc {
     ...
     * @return automatically generated
     */
    public static Mat getStructuringElement(int shape, Size ksize, android.graphics.Point point) {
 ...
 * center.
     * @param i
     */
    public static void blur(Mat src, Mat dst, Size ksize, int i) {
 ...
 * anchor is at the element center.
     ...
     * @param iterations
     */
    public static void erode(Mat src, Mat dst, Mat kernel, android.graphics.Point point, int iterations) {
